"""Unit tests for mcp-package-health tools."""
import pytest, asyncio
from mcp_package_health.server import get_package_health, check_vulnerabilities, get_dependency_graph
...
@pytest.mark.asyncio
async def test_check_vulnerabilities_safe_version():
